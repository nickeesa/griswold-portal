...
/**
 * ============================================================================
 *  EXAMPLE — DO NOT DROP IN AS-IS.  MERGE THIS INTO YOUR PROJECT'S src/index.js
 *  (or src/index.ts — translate the syntax).
 * ============================================================================
 *
 * Every Strapi project already has its own src/index.js with register() and
 * bootstrap() hooks, so this is shipped as a reference, not a live file. Copy the
 * two hook bodies below into your project's existing hooks.
 *
 ...
 *     whole boundary. NOTE: the production DATABASE guards (reject sqlite in prod,
 *     require DATABASE_SSL, reject default DB credentials) live in the companion's
 *     src/index.ts register(), not in a config/database.* file — port them alongside this.
